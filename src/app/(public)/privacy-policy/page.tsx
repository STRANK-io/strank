import { TermsSection } from '@/components/features/terms/TermsAgreement'
  ...
  return (
    <div className="pb-20">
      <header className="sticky top-0 flex w-full items-center justify-center bg-white px-[10px] py-4">
        <Link href="/" className="absolute left-[10px]">
      ...
      <div className="flex flex-col gap-6 overflow-y-auto px-5 text-brand-dark">
        ...
        <TermsSection title="스트랭크에 대한 개인정보 취급방침">
          ...
          <br />
          가입 시에 받는 제공 받는 정보는 아래와 같으며, 서비스 필요에 따라 추가적인 정보제공을
          요청할 수 있습니다.
          <br />
          ...
          <br />
          스트라바 연동을 해제 시에는 스트라바와 연동된 개인정보들은 삭제되며 별도로 계정 완전
          삭제를 원하시는 경우 support@strank.io 으로 삭제요청을 하시기 바랍니다.
          <br />
          스트라바의 개인정보보호정책을 참고하여 주시기 바랍니다.
          https://www.strava.com/legal/privacy
          <br />
          <br />
          4. 개인정보의 보유기간 및 폐기
          <br />
          스트랭크 서비스를 제공받는 동안 서비스 제공을 위해 이용자의 개인정보는 스트랭크에서
          보유하게 됩니다. 단, 부정활동 및 비정상적인 서비스 이용자에 대한 이용기록은 수사협조와
